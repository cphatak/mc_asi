...
from dipolar_distASI_MC import Dipolar_distASI_MC
import os
...
def run_MC(n_run, #job ID number
    ...
    dipolar_MC1 = Dipolar_distASI_MC(a = a, nx = nx, ny = ny, max_nn_dist = max_nn_dist,
